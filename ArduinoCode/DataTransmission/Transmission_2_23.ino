/* 
 *  This code builds on Transmission_2_19 with the capability to transmit data
...
void loop()
{
  ...
  message += "*" + (String)accel.x() + "#" + (String)accel.y() + "#" + (String)accel.z() + "#";
